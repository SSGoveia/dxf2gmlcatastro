...
<!-- Geometria en formato GML       -->
         <cp:geometry><!-- srs Name codigo del sistema de referencia en el que se dan las coordenadas, que debe coincidir con el de la cartografia catastral -->
           <gml:MultiSurface gml:id="MultiSurface_ES.LOCAL.CP.1A" srsName="urn:ogc:def:crs:EPSG::{src}">
             <gml:surfaceMember>
               <gml:Surface gml:id="Surface_ES.LOCAL.CP.1A" srsName="urn:ogc:def:crs:EPSG::{src}">
                  <gml:patches>
                    <gml:PolygonPatch>
                      <gml:exterior>
                        <gml:LinearRing>
